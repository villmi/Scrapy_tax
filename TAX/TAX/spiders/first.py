...
class QuerySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        f = open('C:/Users/54491/Desktop/TAX/%s.data' % code, 'a+')
        for item in items:
            nsrmc = item["xk_nsrmc"]
